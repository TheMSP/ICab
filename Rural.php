...
<html lang="en">
  ...
  <?php include 'partial/rural_db.php'; ?>
  ...
  <?php
        ...
        $sql = "SELECT * FROM `rural` WHERE car_id=$car_id"; 
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal">';?><img src=" <?php echo $row['car_img']; ?> " <?php echo ' class="card-img-top rounded-20 " width="50" alt="..." '?>><?php echo ' </h4>
          </div>
