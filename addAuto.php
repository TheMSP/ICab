...
<!-- Modal -->
<div class="modal fade" id="addAuto" tabindex="-1" aria-labelledby="addAutoLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addAutoLabel">Car Add</h5>
    ...
    $filename = $file['name'];
            ...
            $filepath = $file['tmp_name'];
              ...
              if($fileerror == 0){
                ...
                $sql = "INSERT INTO `auto` ( `car_name`, `car_desc`,`car_rate`, `car_img`, `car_add_dt`) VALUES ('$car_name', '$car_desc', '$car_rate','$destinationfile', current_timestamp())";
